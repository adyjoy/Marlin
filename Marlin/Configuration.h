...
#define STRING_CONFIG_H_AUTHOR "(AdyJ, SKR-Mini-E3-V2.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.08,  13.08 }
    #define DEFAULT_Ki_LIST {   0.73,   0.73 }
    #define DEFAULT_Kd_LIST {  58.41,  58.41 }
  #else
  // Creality Ender-5
  #define DEFAULT_Kp 13.08
  #define DEFAULT_Ki 0.73
  #define DEFAULT_Kd 58.41
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 409.57 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -61, -22, -2 }
...
// not working - having to set a g92 x0 y0 after moving to x-11 y0
#define X_MIN_POS -11
#define Y_MIN_POS 0
#define Z_MIN_POS 0
