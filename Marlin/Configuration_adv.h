/**
 * 
 * ACJ SKR Mini E3 v2.0 - Marlin 2.0.5-bugfix -v0.b
 *
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_HALT "G28XY"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       700  // 550  // (mm) The length of filament for a complete unload.
